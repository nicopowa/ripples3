 ...
 * RIPPLES3 PACKAGE RELEASE v0.0.5
 * 01/02/2025 19:05:16
 */
...
M:"cmd",C:()=>J(this.i)},fc:{g:"upscl",M:"cmd",C:()=>{var b=this.i;K(b,b.u+.5)}},Xb:{g:"copy",M:"cmd",C:()=>y(this)},Vb:{g:"&nbsp;".repeat(5),M:"cmd",C:()=>{}},Wb:{g:"point",M:"swp",C:()=>{var b=this.i;b.G?b.G&&(b.G=!1,b.A.toggle("point",b.G)):ba(b)}},cc:{g:"rain",M:"swp",C:()=>{var b=this.i;b.Oa?(b.Oa=!1,b.A.toggle("rain",!1)):(b.Oa=!0,b.ab=0,b.Ka=new Set,L(b),b.A.toggle("rain"))}},dc:{g:"swirl",M:"cmd",C:()=>{z(this);setTimeout(()=>{var b=this.i;for(let c=0;3>c;c++)ca(b,b.w/2,b.v/2,.3*Math.min(b.w,
...
c.deleteShader(h)}return d}Va(){this.Z||(Q(this,"liquify"),this.Z=!0,this.A.toggle("flow"),this.Pa=performance.now(),R(this),W(this))}Ub(){document.addEventListener("visibilitychange",()=>{(this.isVisible="visible"===document.visibilityState)?this.Va():I(this)});window.addEventListener("resize",()=>{ia(this)});window.addEventListener("hashchange",()=>window.location.reload());const a={ec:this.Cb,Zb:this.Eb,$b:this.Db,bc:this.Za,ac:this.Za,Yb:this.Za};Object.keys(a).forEach(b=>this.B.addEventListener(b,
a[b].bind(this)))}Cb(a){a.preventDefault()}Eb(a){a.preventDefault();const b=a.pointerId;this.mb||(this.mb=!0);this.B.setPointerCapture(b);a=X(this,a);this.s.set(b,{x:a.x,y:a.y,$:a.x,aa:a.y,...Y(this)})}Db(a){a.preventDefault();var b=a.pointerId;this.s.has(b)&&(b=this.s.get(b),a=X(this,a),b.$=b.x,b.aa=b.y,b.x=a.x,b.y=a.y,b.rx=a.rx,b.ry=a.ry,Z(this))}Za(a){a=a.pointerId;this.s.has(a)&&(this.B.releasePointerCapture(a),this.s.delete(a),Z(this))}get w(){return this.B.width}get v(){return this.B.height}yb(a,
